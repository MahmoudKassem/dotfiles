...
syn region   prologClause   matchgroup=prologClauseHead start=+^\s*[a-z]\w*+ matchgroup=Operator end=+\.\s\|\.$+ contains=ALLBUT,prologClause
...
if !exists("prolog_highlighting_clean")
  ...
  if !exists("prolog_highlighting_no_keyword")
    ...
    syn keyword prologKeyword   initialization nil string_chars false select between
    syn keyword prologKeyword   format writeln div mod is_list random random_between maplist member use_module
  endif

  syn match   prologOperator "+\|-\|\*\*\|*\|=\\=\|=:=\|\\==\|=<\|==\|>=\|\\=\|\\+\|=\.\.\|\.\|/\\\|\\/\|-->\|->\|<\|>\|=\|;\|!\|:-\|,\||\|@<\|@>"
  syn match   prologAsIs     "===\|\\===\|<=\|=>"

  syn match   prologDelimiters "(\|)\|\[\|\]\|{\|}"
  syn match   prologVariables /\<\(_\|\u\)\w*\>/ contained
...
hi def link prologClause Function
...
hi def link prologDelimiters     Delimiter
hi def link prologVariables      Normal
