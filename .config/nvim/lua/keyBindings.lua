...
vim.api.nvim_set_keymap('n', '<leader>E', ':NvimTreeToggle<cr>:NvimTreeResize "32%"<cr>', keyMappingOptions)
...
vim.api.nvim_set_keymap('n', '<leader>m', ':lua vim.lsp.diagnostic.show_line_diagnostics()<cr>', keyMappingOptions)
